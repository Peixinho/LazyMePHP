...
<div class="welcome-container">
    <div class="welcome-grid">
        <div class="welcome-card">
            ...
            <a href="/docs/intro" target="_blank">Read the Docs &rarr;</a>
        </div>
        <div class="welcome-card">
            <h3>Routing</h3>
        ...
        <div class="welcome-card">
            ...
            <a href="/docs/orm/basic-crud" target="_blank">Database Guide &rarr;</a>
        </div>
        <div class="welcome-card">
            <h3>Create an API</h3>
            ...
            <a href="/docs/http/api-resources" target="_blank">API Development &rarr;</a>
        </div>
    </div>
</div> 
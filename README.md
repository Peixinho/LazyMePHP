![LazyMePHP](https://raw.githubusercontent.com/Peixinho/LazyMePHP/master/src/img/logo.png)
...
After this, you will have a list of your database tables, where you can select what to build and some other options:
 ...
 - **CSS Button, Input and Table**: Aftert selecting the tables, you could set a css class name for each input, button and table generated automatically by the FORM option. This option is mainly to make it easier to integrate some frontend framework such as bootstrap or whatever.
